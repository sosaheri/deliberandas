        ...
        <div class="col-md-4 ml-auto mr-auto">
            ...
            <div class="card card-login card-plain">
                ...
                <div class="logo-container">
                    <img style="width:250px !important; margin-bottom: -55px !important;" src="{{ asset('assets/img/logo.png') }}" alt="">
                </div>
                </div>
                <div class="card-body ">
                <div class="input-group no-border form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="email" name="email" value="{{ old('email', 'admin@deliberandas.com') }}" required autofocus>
                </div>
                @if ($errors->has('email'))
                ...
                <div class="pull-right">
                    <h6>
                    <a href="{{ route('password.request') }}" class="link footer-link">{{ __('Olvide la contraseña') }}</a>
                    </h6>                
                </div>
                </div>
            </div>
